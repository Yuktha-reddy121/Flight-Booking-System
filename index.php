...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class="bg-info py-5">
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022  (a project by Daniya Muzammil and Bodela Yuktha Sikhara Sai) - <?php echo $_SESSION['setting_name'] ?></div></div>
        </footer>
